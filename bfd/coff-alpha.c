...
/* FIXME!!!  WARNING!!  This is work in progress
   
   This file is an almost exact copy of the MIPS version.  Right
   now it needs major hacking to get it to work with gdb.

   If common stuff is found, perhaps the function
   ecoff_slurp_symbolic_info and friends should be split out...
   In the mean time, it's #ed out.
