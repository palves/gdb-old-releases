...
struct h8_opcode h8_opcodes[] = 
{
  ...
  SOP(O(O_MOV_TO_REG,SB),4,"mov.b"),{ABSMOV|SRC|L_16,RD8,E},{ 0x6,0xA,0x0,RD8,ABSMOV|SRC|A16LIST,E}EOP,
  SOP(O(O_MOV_TO_MEM,SB),4,"mov.b"),{RS8,ABSMOV|DST,E},     { 0x6,0xA,0x8,RS8,ABSMOV|DST|A16LIST,E}EOP,

  SOP(O(O_MOV_TO_REG,SB),6,"mov.b"),{ABSMOV|SRC,RD8,E },    { 0x6,0xA,0x2,RD8,0x0,0x0,SRC|ABSMOV|A24LIST,E }EOP,
  SOP(O(O_MOV_TO_MEM,SB),6,"mov.b"),{RS8,ABSMOV|DST,E },    { 0x6,0xA,0xA,RS8,0x0,0x0,DST|ABSMOV|A24LIST,E }EOP,
