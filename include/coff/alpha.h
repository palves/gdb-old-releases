...
#define PDR_BITS1_RESERVED_BIG		0x3f
...
#define PDR_BITS1_RESERVED_LITTLE	0xfc
#define PDR_BITS1_RESERVED_SH_LITTLE	2
#define PDR_BITS2_RESERVED_LITTLE	0xff
#define PDR_BITS2_RESERVED_SH_LEFT_LITTLE 6
