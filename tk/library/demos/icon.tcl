...
image create bitmap flagup -file $tk_library/demos/images/flagup.bmp \
	-maskfile $tk_library/demos/images/flagup.bmp
image create bitmap flagdown -file $tk_library/demos/images/flagdown.bmp \
	-maskfile $tk_library/demos/images/flagdown.bmp
...
checkbutton $w.frame.b2 -bitmap @$tk_library/demos/images/letters.bmp \
	-indicatoron 0 -selectcolor SeaGreen1
frame $w.frame.left
pack $w.frame.left $w.frame.b1 $w.frame.b2 -side left -expand yes -padx 5m

radiobutton $w.frame.left.b3 -bitmap @$tk_library/demos/images/letters.bmp \
	-variable letters -value full
radiobutton $w.frame.left.b4 -bitmap @$tk_library/demos/images/noletter.bmp \
