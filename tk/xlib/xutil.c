 ...
 * XVisualIDFromVisual --
 *
 *	Retrieves the visual ID for the specified visual type.
 *
 * Results:
 *	Returns a visual ID.
 *
 ...
 * XFree --
 *
 *	Release memory allocated by X emulation routines.
 *
 * Results:
 *	None.
 *
 ...
 * XSync --
 *
 *	Synchronize X server.  This is a noop under Windows.
 *
 * Results:
 *	None.
 *
