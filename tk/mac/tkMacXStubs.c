    ...
    _Xconst char *display_name;
{
    ...
    display->display_name = "Macintosh";
    display->qlen = 0;
...

/*
 * We have one Tk stub at the moment.
 */
int
...
{
    /*
     * This function is a no-op.  This code isn't talking to a real
     * X server so you don't need to grab to it.
     */
    display->request++;
}
