...
{
    TkConsolePrint(gStdoutInterp, buffer, n);
	return n;
}
 ...
 *
 *	returns char*:	A pointer to static global data which contains a C
 *                      string or NULL if the stream is not valid.
 */
...
void
tkMacInstallMWConsole(Tcl_Interp *interp)
{
