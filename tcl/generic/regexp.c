...
/*
 * Note: don't use full ANSI prototypes for the following procedures:
 * prototypes cause problems in the Mac due to a bug in the Think C
 * compiler, and they generate zillions of warnings in gcc because
...
regexp *TclRegComp _ANSI_ARGS_((char *exp));
