...
extern char *		Tcl_Malloc _ANSI_ARGS_((unsigned int size));
extern char *		Tcl_Realloc _ANSI_ARGS_((char *ptr,
			    unsigned int size));
extern void		Tcl_Free _ANSI_ARGS_((char *ptr));

#  define ckalloc(x) Tcl_Malloc(x)
...
EXTERN Tcl_Interp	*Tcl_CreateSlave _ANSI_ARGS_((Tcl_Interp *interp,
		            char *slaveName, int isSafe, int withTk));
...
EXTERN int		Tcl_ExprString _ANSI_ARGS_((Tcl_Interp *interp,
			    char *string));
EXTERN int		Tcl_FilePermissions _ANSI_ARGS_((Tcl_Interp *interp,
			    FILE *file));
...
EXTERN void		Tcl_SetErrorCode _ANSI_ARGS_(
    			    TCL_VARARGS(Tcl_Interp *,interp));
EXTERN void		Tcl_SetFileCloseProc _ANSI_ARGS_((
...
EXTERN char *		Tcl_SetVar2 _ANSI_ARGS_((Tcl_Interp *interp,
			    ...
			    int flags));
EXTERN int		Tcl_ShareChannel _ANSI_ARGS_((char *channelId,
		            Tcl_Interp *interp, Tcl_Interp *srcInterp,
			    Tcl_Interp *destInterp));
...
EXTERN int		Tcl_TransferChannel _ANSI_ARGS_((char *channelId,
		            Tcl_Interp *interp, Tcl_Interp *srcInterp,
			    Tcl_Interp *destInterp));
