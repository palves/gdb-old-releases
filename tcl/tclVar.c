				 ...
				 * or TCL_LEAVE_ERR_MSG bits. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_GetVar2(interp, varName, openParen+1, flags);
	    *openParen = '(';
	    *p = ')';
	    return result;
	}
				 ...
				 * TCL_LIST_ELEMENT, or TCL_LEAVE_ERR_MSG. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_SetVar2(interp, varName, openParen+1, newValue, flags);
	    *openParen = '(';
	    *p = ')';
	    return result;
	}
				 ...
				 * TCL_GLOBAL_ONLY or TCL_LEAVE_ERR_MSG. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_UnsetVar2(interp, varName, openParen+1, flags);
	    *openParen = '(';
	    *p = ')';
	    return result;
	}
    ...
    ClientData clientData;	/* Arbitrary argument to pass to proc. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_TraceVar2(interp, varName, openParen+1, flags,
		    proc, clientData);
	    *openParen = '(';
	    *p = ')';
	    return result;
    ...
    ClientData clientData;	/* Arbitrary argument to pass to proc. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    Tcl_UntraceVar2(interp, varName, openParen+1, flags, proc, clientData);
	    *openParen = '(';
	    *p = ')';
	    return;
	}
				 ...
				 * first trace. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_VarTraceInfo2(interp, varName, openParen+1,
				 ...
				 * whether localName is local or global. */
{
	...
	if (*p == '(') {
	    ...
	    *openParen = '\0';
	    *p = '\0';
	    result = Tcl_UpVar2(interp, frameName, varName, openParen+1,
		    localName, flags);
	    *openParen = '(';
	    *p = ')';
	    return result;
    ...
    scalar:
    return Tcl_UpVar2(interp, frameName, varName, (char *) NULL,
	    localName, flags);
}

/*
