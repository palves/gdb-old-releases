...
%$Id: refcard.tex,v 1.9 1991/10/16 22:08:40 pesch Exp $
...
\par \opt{or discard both}\cr
core \opt{\it file}&read {\it file} as coredump \opt{or discard}\cr
exec \opt{\it file}&use {\it file} as executable only \opt{or discard}\cr
symbol \opt{\it file}&use symbol table from {\it file} \opt{or discard}\cr
...
\centerline{Roland Pesch (pesch@cygnus.com), October 1991---\manvers}
